...
const FORGOT_EMPLOYER_PASSWORD_MUTATION = gql(`
...
export default function Detail() {
  ...
  const [forgotEmployerPassword, { loading, error, data }] = useMutation(
    FORGOT_EMPLOYER_PASSWORD_MUTATION
  );

  useEffect(() => {
    if (data?.forgotEmployerPassword?.success === true) {
      router.push(`/employer-sign-in/request-password-reset`);
    }
  }, [data, router]);
