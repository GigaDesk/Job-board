...
const EMPLOYER_LOGIN_MUTATION = gql(`
...
export default function Detail() {
  ...
  const [employerLogin, { data, loading, error }] = useMutation(
    EMPLOYER_LOGIN_MUTATION
  );
  ...
  useEffect(() => {
    if (data !== undefined && data !== null) {
      AuthenticationToken.token = data.employerLogin;
      window.localStorage.setItem("LastSignedInAs", JSON.stringify("employer"));
      ...
      <Stack spacing={1}>
        ...
        <div className="grid grid-cols-2">
          <button
            ...
            onClick={() => {
              router.push(`/employer-sign-in/forgot-password`);
            }}
          >
            Forgot password?
          </button>
