...
const FIND_ACCEPTED_EMPLOYER_JOB_APPLICATIONS_QUERY = gql(`
...
export default function AcceptedApplicationsTable() {
  const params = useParams();

  const router = useRouter();

  const { refetch, data } = useQuery(FIND_ACCEPTED_EMPLOYER_JOB_APPLICATIONS_QUERY, {
