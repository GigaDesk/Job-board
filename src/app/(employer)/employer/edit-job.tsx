...
const FIND_EMPLOYER_JOB_QUERY = gql(`
    query findEemployerEditJob1($id: Int!){
      findJob(id: $id){
        id
        title
        industry
            ...
            editJob({
              variables: {
                ...
                newjob: {
                  ...
                  jobUrl: handleStringValue(jobinstance.instance.externalApplicationLink),
                  companyName: handleStringValue(jobinstance.instance.companyName),
                  companyLocation: handleStringValue(jobinstance.instance.companyLocation),
                  companyIndustry: handleStringValue(jobinstance.instance.industry),
                  companyDescription: handleStringValue(jobinstance.instance.companyDescription),
                  MinimumEmployees: handleNumberStringValue(jobinstance.instance.minimumEmployees),
                  MaximumEmployees: handleNumberStringValue(jobinstance.instance.maximumEmployees)
                },
              },
            }).catch((res) => {
