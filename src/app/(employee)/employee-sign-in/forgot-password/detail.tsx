...
const FORGOT_EMPLOYEE_PASSWORD_MUTATION = gql(`
...
export default function Detail() {
  ...
  const [forgotEmployeePassword, { loading, error, data }] = useMutation(
    FORGOT_EMPLOYEE_PASSWORD_MUTATION
  );

  useEffect(() => {
    if (data?.forgotEmployeePassword?.success === true) {
      router.push(`/employee-sign-in/request-password-reset`);
    }
  }, [data, router]);
