...
const documents = {
    ...
    "\n    query findEemployerEditJob1($id: Int!){\n      findJob(id: $id){\n        id\n        title\n        industry\n        deadline\n        description\n        requirements\n        level\n        location\n        educationLevel\n        experience\n        jobUrl\n        companyName\n      companyLocation\n      companyIndustry\n      companyDescription\n      MinimumEmployees\n      MaximumEmployees\n      }\n    }\n    ": types.FindEemployerEditJob1Document,
    "\n    query findUnapprovedJob1($id: Int!){\n      findUnapprovedJob(id: $id){\n        id\n        title\n        industry\n        deadline\n        description\n        requirements\n        level\n        location\n        educationLevel\n        experience\n        jobUrl\n      companyName\n      companyLocation\n      companyIndustry\n      companyDescription\n      MinimumEmployees\n      MaximumEmployees\n      }\n    }\n  ": types.FindUnapprovedJob1Document,
