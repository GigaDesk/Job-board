...
export default function StudentSchoolChoice() {
  ...
  return (
    <div className="grid grid-cols-2 justify-items-center ">
      <Choice choice="school" checked={checkedschool} handleChange={handleChangeSchoolChoice} />
      <Choice choice="student" checked={checkedstudent} handleChange={handleChangeStudentChoice}/>
    </div>
  );
}
